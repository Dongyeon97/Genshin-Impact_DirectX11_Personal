...
void CVIBuffer_Cube::Initialize()
{
	...
	{
		MSG_BOX("Failed to Initialize Buffer : CVIBuffer_Cube");
		return;
	}
...
_int CVIBuffer_Cube::PreUpdate(const _float& _fTimeDelta)
{
	return CNonMeshComponent::PreUpdate(_fTimeDelta);
}

_int CVIBuffer_Cube::Update(const _float& _fTimeDelta)
{
	return CNonMeshComponent::Update(_fTimeDelta);
}

_int CVIBuffer_Cube::LateUpdate(const _float& _fTimeDelta)
{
	return CNonMeshComponent::LateUpdate(_fTimeDelta);
}

void CVIBuffer_Cube::Render()
{
	CNonMeshComponent::Render();
}

void CVIBuffer_Cube::EndPlay()
{
	CNonMeshComponent::EndPlay();
}

void CVIBuffer_Cube::Release()
{
	CNonMeshComponent::Release();
}

HRESULT CVIBuffer_Cube::InitializeBuffer()
{
