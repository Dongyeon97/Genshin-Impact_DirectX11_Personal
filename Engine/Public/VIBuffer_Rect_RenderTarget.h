...
class ENGINE_DLL CVIBuffer_Rect_RenderTarget final : public CPrimitiveComponent
{
public:
	explicit CVIBuffer_Rect_RenderTarget() = default;
	virtual ~CVIBuffer_Rect_RenderTarget() = default;
...
public:
	...
	static CVIBuffer_Rect_RenderTarget* Create();
