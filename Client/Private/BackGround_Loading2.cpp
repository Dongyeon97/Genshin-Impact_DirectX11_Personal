...
void CBackGround_Loading2::Initialize()
{
	...
	m_wpRectBuffer.lock()->SetTextureFileInfo(L"Eula_0", 0, 0);
...
_int CBackGround_Loading2::PreUpdate(const _float& _fTimeDelta)
{
	return CActor::PreUpdate(_fTimeDelta);
}

_int CBackGround_Loading2::Update(const _float& _fDeltaDelta)
{
	return CActor::Update(_fDeltaDelta);
}

_int CBackGround_Loading2::LateUpdate(const _float& _fDeltaDelta)
{
	return CActor::LateUpdate(_fDeltaDelta);
}

void CBackGround_Loading2::Render()
{
	BindShaderResources();
...
void CBackGround_Loading2::EndPlay()
{

	CActor::EndPlay();
}

void CBackGround_Loading2::Release()
{

	CActor::Release();
}

HRESULT CBackGround_Loading2::BindShaderResources()
{
