...
class CSlime_Fire_StateMachine final : public CMonsterStateMachine
{
public:
	explicit CSlime_Fire_StateMachine() = default;
	virtual ~CSlime_Fire_StateMachine() = default;
